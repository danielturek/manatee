...
## Import data
mdata <- read.csv('mortalities.simulated.July.csv')
## FL regions
...
nodesToExclude <- c('cold_mort[3, 1]', 'cold_mort[3, 2]', 'p0[5, 2]', 'pi0[5, 2]', 'tide_mort[1]', 'pi[5, 2]', 'p[5, 2]')
...
saveFileName <- paste0('sim.niter', niter, '.RData')

save(list = c('samplesList'), file = saveFileName)


tail(samplesList[[3]][, c('p[1, 1]', 'p[2, 1]', 'p[3, 1]', 'p[4, 1]', 'p[5, 1]', 'p[6, 1]')])
tail(samplesList[[3]][, c('eta[18, 1, 3, 1]', 'eta[18, 1, 3, 2]', 'eta[18, 1, 3, 3]', 
                          'eta[18, 1, 3, 4]', 'eta[18, 1, 3, 5]', 'eta[18, 1, 3, 6]')])
tail(samplesList[[3]][, c('eta[18, 1, 2, 1]', 'eta[18, 1, 2, 2]', 'eta[18, 1, 2, 3]', 
                          'eta[18, 1, 2, 4]', 'eta[18, 1, 2, 5]', 'eta[18, 1, 2, 6]')])
tail((samplesList[[3]][, c('p[1, 1]', 'p[2, 1]', 'p[3, 1]', 'p[4, 1]', 'p[5, 1]', 'p[6, 1]')] +
       matrix(c(rep(0, niter * 3), samplesList[[3]][, 'cold_mort[2, 1]'] / base.mort[1, 1], rep(0, niter * 2)),
              niter, nCauses)) /
       (1 + samplesList[[3]][, 'cold_mort[2, 1]'] / base.mort[1, 1]))
tail(samplesList[[3]][, c('eta[15, 4, 2, 1]', 'eta[15, 4, 2, 2]', 'eta[15, 4, 2, 3]', 
                          'eta[15, 4, 2, 4]', 'eta[15, 4, 2, 5]', 'eta[15, 4, 2, 6]')])
tail((samplesList[[3]][, c('p[1, 4]', 'p[2, 4]', 'p[3, 4]', 'p[4, 4]', 'p[5, 4]', 'p[6, 4]')] +
        matrix(c(rep(0, niter * 3), samplesList[[3]][, 'cold_mort[2, 3]'] / base.mort[4, 1], rep(0, niter * 2)),
               niter, nCauses)) /
       (1 + samplesList[[3]][, 'cold_mort[2, 3]'] / base.mort[4, 1]))
tail(samplesList[[3]][, c('p[1, 4]', 'p[2, 4]', 'p[3, 4]', 'p[4, 4]', 'p[5, 4]', 'p[6, 4]')])
tail(samplesList[[3]][, c('cold_mort[2, 1]', 'cold_mort[2, 2]', 'cold_mort[2, 3]')])
tail(samplesList[[3]][, c('eta[2, 4, 2, 1]', 'eta[2, 4, 2, 2]', 'eta[2, 4, 2, 3]', 
                          'eta[2, 4, 2, 4]', 'eta[2, 4, 2, 5]', 'eta[2, 4, 2, 6]')])
tail(samplesList[[3]][, c('eta[1, 4, 2, 1]', 'eta[1, 4, 2, 2]', 'eta[1, 4, 2, 3]', 
                          'eta[1, 4, 2, 4]', 'eta[1, 4, 2, 5]', 'eta[1, 4, 2, 6]')])
tail(samplesList[[3]][, c('pi[1, 4]', 'pi[2, 4]', 'pi[3, 4]', 'pi[4, 4]', 'pi[5, 4]', 'pi[6, 4]')])
tail(samplesList[[3]][, c('theta[3, 4, 3, 1]', 'theta[3, 4, 3, 2]', 'theta[3, 4, 3, 3]', 
                          'theta[3, 4, 3, 4]', 'theta[3, 4, 3, 5]', 'theta[3, 4, 3, 6]')])
colMeans(samplesList[[3]][, c('theta[18, 4, 3, 1]', 'theta[18, 4, 3, 2]', 'theta[18, 4, 3, 3]', 
                          'theta[18, 4, 3, 4]', 'theta[18, 4, 3, 5]', 'theta[18, 4, 3, 6]')])
colMeans((samplesList[[3]][, c('pi[1, 4]', 'pi[2, 4]', 'pi[3, 4]', 'pi[4, 4]', 'pi[5, 4]', 'pi[6, 4]')] +
        matrix(c(rep(0, niter * 4), samplesList[[3]][, 'tide_mort[3]'] / base.mort[4, 1], rep(0, niter)),
               niter, nCauses)) /
       (1 + samplesList[[3]][, 'tide_mort[3]'] / base.mort[4, 1]))
colMeans(samplesList[[3]][, c('theta[18, 4, 2, 1]', 'theta[18, 4, 2, 2]', 'theta[18, 4, 2, 3]', 
                              'theta[18, 4, 2, 4]', 'theta[18, 4, 2, 5]', 'theta[18, 4, 2, 6]')])
colMeans((samplesList[[3]][, c('pi[1, 4]', 'pi[2, 4]', 'pi[3, 4]', 'pi[4, 4]', 'pi[5, 4]', 'pi[6, 4]')] +
            matrix(c(rep(0, niter * 3), samplesList[[3]][, 'cold_mort[2, 1]'] / base.mort[4, 1], 
                     samplesList[[3]][, 'tide_mort[3]'] / base.mort[4, 1], rep(0, niter)),
                   niter, nCauses)) /
           (1 + rowSums(samplesList[[3]][, c('tide_mort[3]', 'cold_mort[2, 1]')]) / base.mort[4, 1]))

apply(samplesList[[3]][, c('pi[1, 1]', 'pi[2, 1]', 'pi[3, 1]', 'pi[4, 1]', 'pi[5, 1]', 'pi[6, 1]')], 1, sum)
